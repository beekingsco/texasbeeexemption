...
const states: StateInfo[] = [
  ...
  { code: 'AK', name: 'Alaska', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'AZ', name: 'Arizona', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'AR', name: 'Arkansas', status: 'full-page', tier: 1, headline: 'No waiting period — qualify year 1', slug: 'arkansas' },
  { code: 'CA', name: 'California', status: 'researched', tier: 3, headline: 'County-by-county programs available' },
  { code: 'CO', name: 'Colorado', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'CT', name: 'Connecticut', status: 'coming-soon', headline: 'Research in progress' },
  ...
  { code: 'GA', name: 'Georgia', status: 'researched', tier: 2, headline: 'GATE program + property tax pathway' },
  { code: 'HI', name: 'Hawaii', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'ID', name: 'Idaho', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'IL', name: 'Illinois', status: 'coming-soon', headline: 'Research in progress' },
  ...
  { code: 'KY', name: 'Kentucky', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'LA', name: 'Louisiana', status: 'full-page', tier: 1, headline: 'No waiting period for 3+ acres', slug: 'louisiana' },
  { code: 'ME', name: 'Maine', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'MD', name: 'Maryland', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'MA', name: 'Massachusetts', status: 'coming-soon', headline: 'Research in progress' },
  ...
  { code: 'NH', name: 'New Hampshire', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'NJ', name: 'New Jersey', status: 'researched', tier: 2, headline: 'Highest savings potential in US' },
  { code: 'NM', name: 'New Mexico', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'NY', name: 'New York', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'NC', name: 'North Carolina', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'ND', name: 'North Dakota', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'OH', name: 'Ohio', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'OK', name: 'Oklahoma', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'OR', name: 'Oregon', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'PA', name: 'Pennsylvania', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'RI', name: 'Rhode Island', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'SC', name: 'South Carolina', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'SD', name: 'South Dakota', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'TN', name: 'Tennessee', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'TX', name: 'Texas', status: 'full-page', tier: 1, headline: '5 of 7 years ag history required', slug: 'texas' },
  { code: 'UT', name: 'Utah', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'VT', name: 'Vermont', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'VA', name: 'Virginia', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'WA', name: 'Washington', status: 'researched', tier: 2, headline: 'Current use program available' },
  { code: 'WV', name: 'West Virginia', status: 'coming-soon', headline: 'Research in progress' },
  { code: 'WI', name: 'Wisconsin', status: 'coming-soon', headline: 'Research in progress' },
