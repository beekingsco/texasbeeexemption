...
const states: StateInfo[] = [
  ...
  { code: 'OR', name: 'Oregon', status: 'researched', headline: 'EFU zones & farm assessment', slug: 'oregon' },
  ...
  { code: 'WA', name: 'Washington', status: 'researched', tier: 2, headline: 'Current use program available', slug: 'washington' },
