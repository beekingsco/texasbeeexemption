  ...
  return (
    <div style={{ minHeight: '100vh', background: C.white }}>
      ...
      <section style={{ background: `linear-gradient(135deg, ${C.navy} 0%, ${C.blue} 100%)`, padding: '48px 24px', textAlign: 'center' }}>
        <h1 style={{ fontSize: 36, fontWeight: 900, color: C.white, marginBottom: 12 }}>Connecticut Beekeeping<br/>Tax Exemptions</h1>
        <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.8)' }}>PA 490 Farm Assessment Program</p>
      ...
      <section style={{ padding: '48px 24px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <div style={{ background: '#EFF6FF', border: '2px solid #3B82F6', borderRadius: 16, padding: '24px', marginBottom: 32, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 15, color: C.gray }}>We&apos;re building Connecticut town data. Contact us for personalized guidance.</p>
          </div>
          <div className="info-card">
            <h3>🐝 Overview</h3>
            <p>Connecticut&apos;s <strong>PA 490</strong> (Public Act 490) explicitly lists <strong>&quot;the keeping of bees&quot;</strong> as a qualifying agricultural use. This makes Connecticut one of the most bee-friendly states for tax purposes.</p>
            <div className="highlight"><p><strong>Statute Quote:</strong> CT General Statute 1-1q includes &quot;bees&quot; in the definition of agriculture and farming.</p></div>
          </div>
          <div className="info-card">
            <h3>📋 Requirements</h3>
            <ul>
              <li><strong>Minimum Acreage:</strong> Typically 2+ acres for farmland classification</li>
              <li><strong>Income:</strong> $15,000 gross sales (or $2,500 for small farms)</li>
              <li><strong>History:</strong> 2 years farming history typically required</li>
              <li><strong>Deadline:</strong> September 1 - October 31 annually</li>
            </ul>
          </div>
          <div className="info-card">
            <h3>⚖️ Legal Reference</h3>
            <p><strong>CT General Statute 1-1q</strong> — Defines &quot;agriculture&quot; and &quot;farming&quot; to include &quot;bees&quot; explicitly.</p>
          </div>
          <div style={{ background: C.navy, borderRadius: 16, padding: '32px 24px', textAlign: 'center', marginTop: 32 }}>
            ...
            <a href="mailto:info@beekings.com?subject=Connecticut%20Beekeeping%20Exemption" style={{ display: 'inline-block', background: C.green, color: C.navy, fontWeight: 700, fontSize: 16, padding: '14px 28px', borderRadius: 10, textDecoration: 'none' }}>Contact Us →</a>
          </div>
