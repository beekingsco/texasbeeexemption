  ...
  return (
    <div style={{ minHeight: '100vh', background: C.white }}>
      ...
      <section style={{ background: `linear-gradient(135deg, ${C.navy} 0%, ${C.blue} 100%)`, padding: '48px 24px', textAlign: 'center' }}>
        <h1 style={{ fontSize: 36, fontWeight: 900, color: C.white, marginBottom: 12 }}>Illinois Beekeeping<br/>Tax Exemptions</h1>
        <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.8)' }}>Farmland Assessment Program</p>
      ...
      <section style={{ padding: '48px 24px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <div style={{ background: '#EFF6FF', border: '2px solid #3B82F6', borderRadius: 16, padding: '24px', marginBottom: 32, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 15, color: C.gray }}>We&apos;re building Illinois county data. Contact us for personalized guidance.</p>
          </div>
          <div className="info-card">
            <h3>🐝 Overview</h3>
            <p>Illinois farmland assessment law (35 ILCS 200/10-110) explicitly includes <strong>&quot;bees&quot;</strong> as a qualifying agricultural use. This gives beekeepers a clear path to agricultural property tax assessment.</p>
            <div className="highlight"><p><strong>Statute Quote:</strong> Illinois Statute Chapter 35, Article 1, Section 60 lists &quot;bees&quot; explicitly in the definition of &quot;Farm.&quot;</p></div>
          </div>
          <div className="info-card">
            <h3>📋 Requirements</h3>
            <ul>
              <li><strong>Minimum Acreage:</strong> 10+ acres, or contiguous to qualifying farmland</li>
              <li><strong>History:</strong> Land must be farmed for 2 years minimum</li>
              <li><strong>Deadline:</strong> May 1st annually</li>
            </ul>
          </div>
          <div className="info-card">
            <h3>⚖️ Legal Reference</h3>
            <p><strong>35 ILCS 200/10-110</strong> — Illinois farmland assessment statute explicitly includes &quot;apiculture&quot; and &quot;bees&quot;.</p>
          </div>
          <div style={{ background: C.navy, borderRadius: 16, padding: '32px 24px', textAlign: 'center', marginTop: 32 }}>
            ...
            <a href="mailto:info@beekings.com?subject=Illinois%20Beekeeping%20Exemption" style={{ display: 'inline-block', background: C.green, color: C.navy, fontWeight: 700, fontSize: 16, padding: '14px 28px', borderRadius: 10, textDecoration: 'none' }}>Contact Us →</a>
          </div>
