                ...
                <div style={{ background: C.white, borderRadius: '0 0 16px 16px', padding: '28px 20px', textAlign: 'center', marginBottom: 24, border: '1px solid #D5EAFF', borderTop: '1px solid #e2e8f0' }}>
                  ...
                  <div style={{ marginTop: 16, padding: '12px 16px', background: '#ECFDF5', border: '1px solid #A7F3D0', borderRadius: 10, textAlign: 'left' }}>
                    <p style={{ fontSize: 13, color: '#065F46', lineHeight: 1.5, margin: 0 }}>
                      <strong>✅ Good news:</strong> Arkansas uses a "current use" system — you can qualify for agricultural valuation based on your current agricultural activity, no waiting period required.
                    </p>
                  </div>
                </div>
